...
class ParkingLotTopo(Topo):
    ...
    def build(self, bw1=10, bw2=8, delay="2ms", loss=0, number_of_hosts=40,jitter=None):
        ...
        self.addLink(s1, s2, bw=bw1, delay=delay, loss=loss, max_queue_size=100, jitter=jitter)
        self.addLink(s2, s3, bw=bw2, delay=delay, loss=loss, max_queue_size=100, jitter=jitter)
